...
D="/home/$USER/Cabinet/98_Resources/02_Backups/09_Emails/" # Backup Location
U="user@proton.me" # Put Your Protonmail Username Here

# Create backup
$A --operation $O --dir $D --user $U --telemetry
tar -cJvf "Proton-Mail-Backup_"$DATE.tar.xz -C ./ markgkaitting@proton.me
md5sum "Proton-Mail-Backup_"$DATE.tar.xz > "Proton-Mail-Backup_"$DATE.tar.xz.md5
rm -fr markgkaitting@proton.me
echo ""
